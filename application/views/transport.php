...
<div class="content">
    <div class="col-md-9" style="margin-top: -38px;">
        <?php if ($all_annonce_transport !=null):?>
            <div class="col-md-12 page-header" style="background-color: #313334;font-color:white;">
                <h3 style="color:#ffffff;"><?php if ($total_number_annonce_transport>1) echo $total_number_annonce_transport .' Transports';else echo $total_number_annonce_transport .' Transport' ?></h3>

            </div>

            <?php foreach($all_annonce_transport as $r): ?>
